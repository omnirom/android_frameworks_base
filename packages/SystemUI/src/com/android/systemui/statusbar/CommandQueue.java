...
public class CommandQueue extends IStatusBar.Stub implements
    ...
    private static final int MSG_WALLET_ACTION_LAUNCH_GESTURE = 85 << MSG_SHIFT;
    private static final int MSG_DISPLAY_REMOVE_SYSTEM_DECORATIONS = 86 << MSG_SHIFT;
    private static final int MSG_DISABLE_ALL  = 87 << MSG_SHIFT;
