...
public class ComputerEngine implements Computer {
    ...
    /**
     * List of packages for Aurora store and services.
     */
    private static final List<String> AURORA_PACKAGES = List.of("com.aurora.services", "com.aurora.store");
    ...
    public final PackageInfo generatePackageInfo(PackageStateInternal ps,
        ...
        if (p != null) {
            ...
            // Add an new guard with the Aurora store and services because Gapps
            // build have always the com.google.android.gms and com.android.vending installed
            final boolean MicrogBuildType = AURORA_PACKAGES.contains(p.getPackageName());
            ...
            final Set<String> grantedPermissions = (((flags & PackageManager.GET_PERMISSIONS) == 0
                    || ArrayUtils.isEmpty(p.getRequestedPermissions())) && !isMicroG && !MicrogBuildType) ? Collections.emptySet()
